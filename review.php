            ...
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <i class="fa fa-star fa-2x star-rev" data-index="5"></i>
                    ...
                    <div class="form-group" style = "margin-top: 15px;">
                        <label class="title-label" for="review-title" style="font-size: 16px; font-weight: bold;"></label>
                        <input type ="text" name = "review-title" id = "review-title" style="width: 100%; margin-body: 10px;">
                    ...
                    <div class = "form-group">
                        <button class="btn-outline-danger" id="review-submit" name="review-submit" type="submit" style="width: 100%;">Review</button>
                    </div>
            </form>
        </div>
    </div>
